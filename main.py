...
from prediction_helper import predict  #linked to your prediction_helper.py

# Set the page configuration and title
st.set_page_config(page_title="FinSafe: AI Driven Credit Scoring", page_icon="")
st.title("FinSafe: AI Driven Credit Scoring")
